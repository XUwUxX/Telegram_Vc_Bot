...
@Client.on_message(filters.command(["start", "help"]) & filters.private & ~filters.channel)
async def start(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton("💬 Group", url="https://t.me/lisa_is_me"),
...
async def gstart(_, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[
            InlineKeyboardButton(text="🎙️ Support Group 🎙️", url="https://t.me/lisa_is_me")
            ]]
        )
    )


@Client.on_message(filters.command(["cmdlist", "cmd"]) & filters.private & ~filters.channel)
